...
function executarOperacao() {
  leitor.question('Digite a operação (ex: Somar, Bhaskara) ou "Sair" para encerrar: ', (operacao: string) => {
    ...
    if (operacao.toLowerCase() === 'bhaskara') {
      leitor.question('Digite os coeficientes a, b, c separados por espaço: ', (entrada: string) => {
      ...
      leitor.question('Digite dois números separados por espaço: ', (entrada: string) => {
        const valores = entrada.split(' ').map(Number);
